...
import HeadOfficeApplicationViewPage from './Dashboard/HeadOfficeDashboard/Years/Applications/HeadOfficeApplicationViewPage';
    ...
    <div className='relative mt-4 '>
      <div className='container mx-auto p-4 lg:p-0'>
        <Switch location={location}>
          ...
          />
          <AdminRoute path='/admin/users/:userId' component={UserDetailPage} />
          ...
          />
          <AuthenticatedRoute
            path='/headOffice/years/add'
            component={AddYearPage}
          />
          <AuthenticatedRoute
            path='/headOffice/overview/sales'
            component={SalesOverviewPage}
          />
          <AuthenticatedRoute
            path='/headOffice/overview'
            component={AllTimeOverviewPage}
          />
          <AuthenticatedRoute
            path='/headOffice/years/:yearId/priority'
            component={YearPriorityUpdatePage}
          />
          <AuthenticatedRoute
            path='/headOffice/years/:yearId/charts'
            component={YearChartsPage}
          />
          <AuthenticatedRoute
            path='/headOffice/years/:yearId/applications/:applicationId'
            component={HeadOfficeApplicationViewPage}
          />
          <AuthenticatedRoute
            path='/headOffice/years/:yearId/applications'
            component={YearApplicationsPage}
          />
          <AuthenticatedRoute
            path='/headOffice/years/:yearId'
            component={YearOverviewPage}
          />
          <AuthenticatedRoute path='/retail/guide' component={GuidePage} />
          <AuthenticatedRoute
            path='/retail/:retailLocationId/applications/:applicationId'
            component={ApplicationPage}
          />
          <AuthenticatedRoute
            path='/retail/:retailLocationId/data'
            component={RetailLocationDataPage}
          />
          <AuthenticatedRoute
            path='/retail/:retailLocationId'
            component={RetailLocationDetailPage}
          />
          <AuthenticatedRoute
            path='/areas/:areaId/retail/:retailLocationId/applications/:applicationId'
            component={AreaManagerApplicationViewPage}
          />
          <AuthenticatedRoute
            path='/areas/:areaId/data'
            component={AreaDataPage}
          />
          <AuthenticatedRoute
            path='/areas/:areaId'
