        ...
        <>
          ...
          <div className='my-8'>
            <div className='my-2 card shadow-md rounded-md'>
              ...
              <div className='px-2 py-1'>
                <p>
                  <span className='font-bold'>Name:</span> {area.name}
                </p>
                <p>
                  <span className='font-bold'>Number of retailer:</span>{' '}
                  {area.locationCount}
                </p>
          ...
          <div className='my-4 card shadow-md rounded-md'>
            ...
            <div className='px-2 py-2 flex'>
              <Link
                to={`/areas/${area.id}/data`}
                className='bg-primary hover:opacity-75 text-white py-2 px-4 rounded pointer mr-2'
              >
                Data overview
              </Link>
              <button
