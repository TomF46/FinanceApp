      ...
      <div className='my-2 card shadow-md rounded-md p-4'>
        ...
        <div className='my-4'>
          <h1 className='text-primary font-bold text-2xl'>
            Why we need you to complete this
          </h1>
          <p className='mt-2'>
            This tool is to allow us to easily gain information about each of
            our locations income and expenditure over a certain period and
            allows us to determine their financial health. Depending on your
            answers we will compute how much we are going to invest in your
            location so it is beneficial to be as accurate as possible, this
            will also be checked by your area managers and any erroneous data
            will be rejected and you will have to amend your application until
            they are happy.{' '}
          </p>
        </div>
        <div className='my-4'>
        ...
        <div className='my-4'>
          ...
          <p className='mt-2'>
            Next you need to complete your application, fill in each value
            making sure all the information is correct for your location. You
            can find helpful tooltips by hovering or clicking on the input
            labels. Please ensure all section are complete before submitting.
          </p>
        </div>
        <div className='my-4'>
          <h1 className='text-primary font-bold text-2xl'>Step 3</h1>
          <p className='my-2'>
            Once you have submitted your area manager will now be able to view
            your submission and either reject (with a reason) or accept your
            submission, all you need to do is wait. Once the area manager is
            finished the status on your homepage will change to one of the
            following.
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              of the amount you will recieve now your application has been
              accepted
            </li>
          </ul>
        </div>
