    ...
    <div className='Retail-manager-dashboard'>
      <div className='grid grid-cols-12 pb-4'>
        <div className='col-span-12 lg:col-span-3 lg:mr-4 mb-4 lg:mb-0 px-4 overflow-hidden shadow-md rounded-md page'>
          ...
          <p className='my-2'>
            This is your dashboard, you can manage your retail locations and any
          ...
          <p className='my-2'>
            ...
            >
              View our handy step by step guide
            </Link>
          </p>
        </div>
            ...
            <>
                ...
                <div className='card shadow-md rounded-md'>
                  <div className='bg-primary rounded-t-md'>
                    <p className='text-white font-bold text-lg px-2 py-1'>
                      My Locations Managed
                    </p>
                  </div>
                  <div>
                    <RetailLocationsList
                      retailLocations={retailManager.retailLocationsManaged}
                      isAdmin={false}
                    />
                  </div>
                </div>
              ...
              <div>
                <div className='card shadow-md rounded-md mb-4'>
                  ...
                  <div>
                    {retailManager.applications.notSubmitted.length +
                      retailManager.applications.returned.length >
                    0 ? (
                      <ApplicationsList
                        applications={getApplicationsRequireAttention(
                          retailManager.applications,
                        )}
                      />
                    ) : (
              ...
              <div>
                <div className='card shadow-md rounded-md mb-4'>
                  <div className='bg-primary rounded-t-md'>
                    <p className='text-white font-bold text-lg px-2 py-1'>
                      Applications Awaiting Area Manager Response
                    </p>
                  </div>
                  <div>
                    {retailManager.applications.submitted.length > 0 ? (
                      <ApplicationsList
                        applications={retailManager.applications.submitted}
                      />
                    ) : (
                      <p className='text-center p-4'>
                ...
                <div className='card shadow-md rounded-md'>
                  ...
                  <div>
                    {retailManager.applications.accepted.length > 0 ? (
                      <ApplicationsList
                        applications={retailManager.applications.accepted}
                      />
                    ) : (
                      <p className='text-center p-4'>
