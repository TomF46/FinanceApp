...
const ExpensesSection = ({ expenses, onExpensesChange, expensesErrors }) => {
      ...
      <div className='my-4'>
        <div className='my-2 card shadow-md rounded-md'>
          ...
          <div className='p-2'>
            ...
            <div className='mb-2'>
              <p className='font-bold text-money-negative'>
                Total expenses: <MoneyFormat value={getTotalExpenses()} />
              </p>
            </div>
          </div>
        </div>
