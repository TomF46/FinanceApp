        ...
        <>
            ...
            <div className='my-2 card shadow-md rounded-md'>
              <div className='bg-primary rounded-t-md'>
                <p className='text-white font-bold text-lg px-2 py-1'>
                  {retailLocation.name} Info
                </p>
              </div>
              <div className='px-2 py-1'>
                <p>
                  <span className='font-bold'>Name:</span> {retailLocation.name}
                </p>
                <p>
                  <span className='font-bold'>Area:</span> {retailLocation.area}
                </p>
                <p>
          ...
          <div className='my-4 card shadow-md rounded-md'>
            ...
            <div className='px-2 py-2 flex'>
              <Link
                to={`/retail/${retailLocation.id}/data`}
                className='bg-primary hover:opacity-75 text-white py-2 px-4 mr-2 rounded pointer'
              >
                Data overview
              </Link>
              <button
          ...
          <div className='my-8'>
            <div className='my-2 card shadow-md rounded-md'>
              <div className='bg-primary rounded-t-md'>
                <p className='text-white font-bold text-lg px-2 py-1'>
                  {retailLocation.name} Applications
                </p>
              </div>
              <div>
                {retailLocation.applications.length > 0 ? (
                  <ApplicationsList
                    applications={retailLocation.applications}
                  />
                ) : (
