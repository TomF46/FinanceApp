      ...
      <form>
        <div className='my-8'>
          <div className='my-2 card shadow-md rounded-md'>
            ...
            <div className='p-2'>
              <p className='my-2'>
                Add a new reporting year below, please enter the year that will
                be covered by these applications. Applications will be sent to
                retailers once you choose to publish.
              </p>
              {errors.onSave && (
