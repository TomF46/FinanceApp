            ...
            <div className="grid grid-cols-12 pb-4">
                ...
                <div className="col-span-12 lg:col-span-9">
                    <div className="card shadow-md rounded-md px-2 py-4 mb-4">
                        <p>This is the head office dashboard, as a head office user it is your responsibility to create and manage reporting years. Once a new application year is created each retailer will recieve a request to submit an application for that year. As a head office user you will also be able to view high level company wide data for each period by selecting the year from the list below.</p>
                    </div>
                    <YearsDashboard />
                </div>
            </div>
