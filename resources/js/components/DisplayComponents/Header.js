...
const Header = () => {
  ...
  function confirmLogout() {
    confirm('Confirm logout', `Are you sure you want to logout?`, handleLogout);
  }
  ...
  return (
    <nav className='flex items-center justify-between flex-wrap p-4 shadow-md'>
      <div className='flex items-center flex-shrink-0  mr-6'>
        <Link to='/'>
          <h1 className='logo-text font-bold text-2xl'>
      ...
      <div className='block md:hidden'>
        <button
          className='flex items-center px-3 py-2 border rounded text-white border-teal-400 hover:text-white hover:border-white pointer'
        ...
        <div className='border-t mt-2 md:border-0 md:mt-0'>
          {userIsAuthenticated && (
            <>
              ...
              >
                <svg
                  className='text-grey-800 h-5 w-5'
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
                  stroke='currentColor'
