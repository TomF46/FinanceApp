...
const RetailInvestmentSummaryTable = ({ investmentSummary }) => {
  return (
      ...
      <table className='table-fixed w-full'>
        <tbody>
          <tr className='bg-gray-200'>
            <td className='pl-2'>
              Total investment from Non-operating income data
            </td>
            <td>
              <MoneyFormat value={investmentSummary.totalFromNOI} />
            </td>
          </tr>
          <tr>
            <td className='pl-2'>Total investment from sales data</td>
            <td>
              <MoneyFormat value={investmentSummary.totalFromSales} />
            </td>
          </tr>
          <tr className='bg-gray-200'>
            <td className='pl-2'>Total investment from net profit data</td>
            <td>
              <MoneyFormat value={investmentSummary.totalFromNetProfit} />
            </td>
          </tr>
          <tr>
            ...
            >
              <MoneyFormat value={investmentSummary.total} />
            </td>
          </tr>
        </tbody>
      </table>
