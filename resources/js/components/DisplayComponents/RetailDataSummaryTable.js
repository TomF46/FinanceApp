            ...
            <table className="table-fixed w-full">
                <tbody>
                    <tr className="bg-gray-200">
                        ...
                        <td><MoneyFormat value={retailDataSummary.totalNOIncome} /></td>
                    </tr>
                    <tr>
                        <td className="pl-2">Total sales income</td>
                        <td><MoneyFormat value={retailDataSummary.totalSalesIncome} /></td>
                    </tr>
                    <tr className="bg-gray-200">
                        <td className="pl-2">Total Income</td>
                        <td><MoneyFormat value={retailDataSummary.totalIncome} /></td>
                    </tr>
                    <tr>
                        <td className="pl-2">Total Expenses</td>
                        <td><MoneyFormat value={retailDataSummary.totalExpenses} /></td>
                    </tr>
                    <tr className="bg-gray-200">
                        <td className="pl-2 font-bold">Total profit/loss</td>
                        <td className={`font-bold ${getMoneyTextColorClass(retailDataSummary.totalProfitLoss)}`}><MoneyFormat value={retailDataSummary.totalProfitLoss} /></td>
                    </tr>
                </tbody>
            </table>
        </div>
