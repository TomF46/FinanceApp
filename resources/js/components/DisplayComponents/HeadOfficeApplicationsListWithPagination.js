...
import HeadOfficeApplicationsList from "./HeadOfficeApplicationsList";


const HeadOfficeApplicationsListWithPagination = ({ paginationData, onPageChange }) => {
    return (
        <div className="application-list-w-pagination">
            <HeadOfficeApplicationsList applications={paginationData.data} />
...
HeadOfficeApplicationsListWithPagination.propTypes = {
    paginationData: PropTypes.object.isRequired,
    onPageChange: PropTypes.func.isRequired
};

export default HeadOfficeApplicationsListWithPagination;